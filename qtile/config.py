...
keys = [
    ...
    # Key([hyper], "space", lazy.layout.next(), desc="Move window focus to other window"),
    ...
    Key(
        [hyper],
        "1",
        lazy.spawn('grim -g "$(slurp)" - | tesseract -l "eng" stdin stdout | wl-copy'),
        # lazy.spawn("wofi"),
    ),
    ...
    Screen(
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(text=" "),
                widget.Backlight(
                    backlight_name="apple-panel-bl",
                    brightness_files="brightness",
                ),
                widget.TextBox(text=" "),
                widget.TextBox(text=" "),
                widget.Volume(),
...
# wl_input_rules = None
# wl_input_rules = {
#     "1452:641:Apple Internal Keyboard / Trackpad": InputConfig(tap=True, natural_scroll=True),
#     "Apple Internal Keyboard / Trackpad": InputConfig(tap=True, natural_scroll=True),
#     "*": InputConfig(tap=True, natural_scroll=True),
#     "type:keyboard": InputConfig(xkb_options="caps:hyper"),
# }
